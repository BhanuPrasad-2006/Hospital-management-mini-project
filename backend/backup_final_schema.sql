...
\restrict 1R869KLwZxkuaJ5aOIG1wwc8xzdonDbkssi37Ev1iNid7qFcTeo7ZFW12jN8bcp
...
262baf66-a6d3-469b-9851-68ef63bb0c0f	PAT006	\N	\\x62353937336464343266653863636534343630333635653939313262646365633a3832323538333233386134316232383533623033653031656666393637623737	\\x66666634383037663732636263353230653835646138643666303561323139653a3731353934663063343161366362356135383536616436633732653334313731	2004-01-01 00:00:00	male	\N	\\x34336438366162323735653337646161343934613065343264333134336663623a6363626366656565356635316165393866383133316661313238396236386633	\N	\N	\N	\N	123456	\N	{}	{}	\N	\N	f	en	light	t	f	\N	2026-04-13 12:05:13.44	2026-04-13 12:05:13.44
16e37a8c-818e-4a85-aee9-a675fb0222a3	PAT0090	\N	\\x36663334306339643164366630303565346161363935626165346134643366303a3864363133313739393036623331306431666639633863343736303537393861	\\x35366564303165356234313563653161613030653862626263633934336465383a6436633965613465636361623532313134343930313834326333653332343539	2004-01-01 00:00:00	male	\N	\\x36623366303931363164316265303733643831373063386263313232633833333a3636333965633439353062303330646137376466386164613438313664666437	\N	\N	\N	\N	123456	\N	{}	{}	\N	\N	f	en	light	t	f	\N	2026-04-13 12:11:53.268	2026-04-13 12:11:53.268
\.
...
--
-- Name: BloodRequest BloodRequest_patientId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bhanu
--

ALTER TABLE ONLY public."BloodRequest"
    ADD CONSTRAINT "BloodRequest_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES public."Patient"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: DietPlan DietPlan_patientId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bhanu
--

ALTER TABLE ONLY public."DietPlan"
    ADD CONSTRAINT "DietPlan_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES public."Patient"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: DispenseLog DispenseLog_patientId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bhanu
--

ALTER TABLE ONLY public."DispenseLog"
    ADD CONSTRAINT "DispenseLog_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES public."Patient"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: DoctorSettings DoctorSettings_doctorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bhanu
--

ALTER TABLE ONLY public."DoctorSettings"
    ADD CONSTRAINT "DoctorSettings_doctorId_fkey" FOREIGN KEY ("doctorId") REFERENCES public."Doctor"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: LabReport LabReport_technicianId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bhanu
--

ALTER TABLE ONLY public."LabReport"
    ADD CONSTRAINT "LabReport_technicianId_fkey" FOREIGN KEY ("technicianId") REFERENCES public."Staff"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: Notification Notification_doctorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bhanu
--

ALTER TABLE ONLY public."Notification"
    ADD CONSTRAINT "Notification_doctorId_fkey" FOREIGN KEY ("doctorId") REFERENCES public."Doctor"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: Notification Notification_staffId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bhanu
--

ALTER TABLE ONLY public."Notification"
    ADD CONSTRAINT "Notification_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES public."Staff"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: PatientSettings PatientSettings_patientId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bhanu
--

ALTER TABLE ONLY public."PatientSettings"
    ADD CONSTRAINT "PatientSettings_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES public."Patient"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: StaffSettings StaffSettings_staffId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bhanu
--

ALTER TABLE ONLY public."StaffSettings"
    ADD CONSTRAINT "StaffSettings_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES public."Staff"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: VitalsReading VitalsReading_recordedBy_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bhanu
--

ALTER TABLE ONLY public."VitalsReading"
    ADD CONSTRAINT "VitalsReading_recordedBy_fkey" FOREIGN KEY ("recordedBy") REFERENCES public."Staff"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
\unrestrict 1R869KLwZxkuaJ5aOIG1wwc8xzdonDbkssi37Ev1iNid7qFcTeo7ZFW12jN8bcp
